...
namespace Native {
    ...
    void RegisterMagnetExtendedFamily()
    {
        ...
        ic = InitialConditionsService::Get("Magnet1J");
        ...
        ic = InitialConditionsService::Get("Magnet2J");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 1000.0;
        ...
        ic = InitialConditionsService::Get("Magnet1Power3");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 1000.0;
        ...
        ic = InitialConditionsService::Get("Magnet2Power3");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 1000.0;
