...
namespace Native {
    ...
    void RegisterAttractors3DFamily()
    {
        ...
        ic = InitialConditionsService::Get("Lorenz");
        ...
        ic = InitialConditionsService::Get("Thomas");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 256.0;
        ...
        ic = InitialConditionsService::Get("Dadras");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 256.0;
        ...
        ic = InitialConditionsService::Get("Pickover");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 256.0;
        ...
        ic = InitialConditionsService::Get("Aizawa");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 256.0;
        ...
        ic = InitialConditionsService::Get("Halvorsen");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 256.0;
        ...
        ic = InitialConditionsService::Get("ChenLee");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 256.0;
