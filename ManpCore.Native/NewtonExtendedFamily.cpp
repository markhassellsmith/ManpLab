...
namespace Native {
    ...
    void RegisterNewtonExtendedFamily()
    {
        ...
        ic = InitialConditionsService::Get("NewtonQuartic");
        ...
        //spec.defaultCenterY = 0.0;
        //spec.defaultZoom = 0.5;
        ic = InitialConditionsService::Get("NewtonQuintic");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 100.0;
        ...
        //spec.defaultCenterY = 0.0;
        //spec.defaultZoom = 0.5;
        ic = InitialConditionsService::Get("NewtonSextic");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 100.0;
        ...
        ic = InitialConditionsService::Get("NewtonSin");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 100.0;
        ...
        ic = InitialConditionsService::Get("NewtonCosh");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        ...
        //spec.defaultCenterY = 0.0;
        //spec.defaultZoom = 0.5;
        ic = InitialConditionsService::Get("NewtonBasin");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 100.0;
