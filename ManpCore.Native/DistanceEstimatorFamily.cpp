...
namespace Native {
    ...
    void RegisterDistanceEstimatorFamily()
    {
        ...
        ic = InitialConditionsService::Get("MandelbrotDEM");
        ...
        ic = InitialConditionsService::Get("JuliaDEM");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 256.0;
        ...
        ic = InitialConditionsService::Get("BurningShipDEM");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 256.0;
        ...
        //spec.defaultCenterY = 0.0;
        //spec.defaultZoom = 1.0;
        ic = InitialConditionsService::Get("TricornDEM");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 256.0;
