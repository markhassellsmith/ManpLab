...
namespace Native {
    ...
    void RegisterComplexFunctionsFamily()
    {
        ...
        ic = InitialConditionsService::Get("SqrTrig");
        ...
        ic = InitialConditionsService::Get("TrigSqr");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        ...
        //spec.defaultCenterY = 0.0;
        //spec.defaultZoom = 0.75;  // Viewport of 4.0 by 2.25
        ic = InitialConditionsService::Get("TrigPlusTrig");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 100.0;
        ...
        //spec.defaultCenterY = 0.0;
        //spec.defaultZoom = 0.75;  // Viewport of 4.0 by 2.25
        ic = InitialConditionsService::Get("TrigXTrig");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        ...
        ic = InitialConditionsService::Get("Sqr1OverTrig");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        ...
        ic = InitialConditionsService::Get("ZxTrigPlusZ");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 100.0;
        ...
        ic = InitialConditionsService::Get("TetrationZtoZ");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 100.0;
        ...
        //spec.defaultCenterY = 0.0;
        //spec.defaultZoom = 0.75;  // Viewport of 4.0 by 2.25
        ic = InitialConditionsService::Get("CosTan");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 1000.0;  // Needs higher bailout for this function
