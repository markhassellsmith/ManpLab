...
namespace Native {
    ...
    void RegisterHybridFamily()
    {
        ...
        ic = InitialConditionsService::Get("MandelBurningHybrid");
        ...
        ic = InitialConditionsService::Get("MandelLambdaMix");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 256.0;
        ...
        ic = InitialConditionsService::Get("TricornPhoenixHybrid");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 256.0;
        ...
        //spec.defaultCenterY = 0.0;
        //spec.defaultZoom = 1.0;
        ic = InitialConditionsService::Get("NewtonMandelBlend");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        ...
        ic = InitialConditionsService::Get("SineMandelHybrid");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 100.0;
        ...
        ic = InitialConditionsService::Get("ExpMandelBlend");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 256.0;
        ...
        //spec.defaultCenterY = 0.0;
        //spec.defaultZoom = 1.0;
        ic = InitialConditionsService::Get("MultiPowerCycle");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 256.0;
        ...
        //spec.defaultCenterY = 0.0;
        //spec.defaultZoom = 1.0;
        ic = InitialConditionsService::Get("MagnetMandelHybrid");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 256.0;
        ...
        //spec.defaultCenterY = 0.0;
        //spec.defaultZoom = 1.0;
        ic = InitialConditionsService::Get("CollatzHybrid");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 256.0;
        ...
        //spec.defaultCenterY = 0.0;
        //spec.defaultZoom = 1.0;
        ic = InitialConditionsService::Get("CelticBurningHybrid");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 256.0;
