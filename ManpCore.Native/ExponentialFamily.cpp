...
namespace Native {
    ...
    void RegisterExponentialFamily()
    {
        ...
        ic = InitialConditionsService::Get("Exponential");
        ...
        ic = InitialConditionsService::Get("MandelExp");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 256.0;
        ...
        ic = InitialConditionsService::Get("LMandelExp");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 256.0;
        ...
        ic = InitialConditionsService::Get("LLambdaExp");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 256.0;
        ...
        ic = InitialConditionsService::Get("ZToTheZ");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 256.0;
        ...
        ic = InitialConditionsService::Get("Logarithm");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 256.0;
