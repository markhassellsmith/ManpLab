...
namespace Native {
    ...
    void RegisterLambdaExtendedFamily()
    {
        ...
        ic = InitialConditionsService::Get("LambdaPower3");
        ...
        ic = InitialConditionsService::Get("LambdaPower4");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 100.0;
        ...
        ic = InitialConditionsService::Get("LambdaTanh");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        ...
        ic = InitialConditionsService::Get("LambdaTan");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 50.0;
        ...
        ic = InitialConditionsService::Get("LambdaSquared");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 100.0;
        ...
        ic = InitialConditionsService::Get("LambdaFlip");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        ...
        ic = InitialConditionsService::Get("LambdaModified");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 100.0;
        ...
        ic = InitialConditionsService::Get("LambdaPhoenix");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 100.0;
