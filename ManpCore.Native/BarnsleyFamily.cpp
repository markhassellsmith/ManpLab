...
namespace Native {
    ...
    void RegisterBarnsleyFamily()
    {
        ...
        ic = InitialConditionsService::Get("BarnsleyM1");
        ...
        ic = InitialConditionsService::Get("BarnsleyJ1");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        ...
        ic = InitialConditionsService::Get("BarnsleyM2");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 256.0;
        ...
        ic = InitialConditionsService::Get("BarnsleyJ2");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 64.0;
        ...
        //spec.defaultCenterY = 0.0;
        //spec.defaultZoom = 0.75;  // Viewport of approximately 4.00 by 2.25
        ic = InitialConditionsService::Get("BarnsleyM3");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 256.0;
        ...
        ic = InitialConditionsService::Get("BarnsleyJ3");
        spec.defaultCenterX = ic.centerX;
        spec.defaultCenterY = ic.centerY;
        spec.defaultZoom = ic.zoom;
        spec.defaultBailout = 64.0;
